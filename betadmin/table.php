                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">2</th>
                          <td>UNDER 1,5</td>
                          <td><?php echo abs( number_format( (($time_A_totalDeJogosUnder15*100)/$time_A_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">3</th>
                          <td>UNDER 2,5</td>
                          <td><?php echo abs( number_format( (($time_A_totalDeJogosUnder25*100)/$time_A_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">4</th>
                          <td>UNDER 3,5</td>
                          <td><?php echo abs( number_format( (($time_A_totalDeJogosUnder35*100)/$time_A_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">5</th>
                          <td>UNDER 5,5</td>
                          <td><?php echo abs( number_format( (($time_A_totalDeJogosUnder55*100)/$time_A_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                          <tr>
                          <th scope="row">6</th>
                          <td>UNDER 7,5</td>
                          <td><?php echo abs( number_format( (($time_A_totalDeJogosUnder75*100)/$time_A_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>OVER 0,5</td>
                          <td>
                            <?php echo abs( number_format( (($time_B_Under05zeroAzero*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?>
                          </td>
                        </tr>
                        <tr>
                          <th scope="row">2</th>
                          <td>UNDER 1,5</td>
                          <td><?php echo abs( number_format( (($time_B_totalDeJogosUnder15*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">3</th>
                          <td>UNDER 2,5</td>
                          <td><?php echo abs( number_format( (($time_B_totalDeJogosUnder25*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">4</th>
                          <td>UNDER 3,5</td>
                          <td><?php echo abs( number_format( (($time_B_totalDeJogosUnder35*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                        <tr>
                          <th scope="row">5</th>
                          <td>UNDER 5,5</td>
                          <td><?php echo abs( number_format( (($time_B_totalDeJogosUnder55*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                          <tr>
                          <th scope="row">6</th>
                          <td>UNDER 7,5</td>
                          <td><?php echo abs( number_format( (($time_B_totalDeJogosUnder75*100)/$time_B_totalDeJogos)-100, 1) )."%"."<br>"; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
